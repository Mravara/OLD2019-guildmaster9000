...
urlpatterns = [
    ...
    path('<int:raid_id>/start/', views.start_raid, name='start'),
    ...
    path('<int:raid_id>/bench_raider/<int:raider_id>/', views.bench_raider, name='bench_raider'),
    path('<int:raid_id>/unbench_raider/<int:raider_id>/', views.unbench_raider, name='unbench_raider'),
